...
public class studyTest8 {
    ...
    void create_new_study(){
        com.test_java.junit5.lecture7_테스트인스턴스.Study actual = new Study(++value);
